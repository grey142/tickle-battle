...
#define LOW_PRECISION`),t}function b0(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Ic?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===jh?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===gn&&(t="SHADOWMAP_TYPE_VSM"),t}function x0(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Oi:case Bi:t="ENVMAP_TYPE_CUBE";break;case ya:t="ENVMAP_TYPE_CUBE_UV";break}return t}function M0(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Bi:t="ENVMAP_MODE_REFRACTION";break}return t}function S0(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case kc:t="ENVMAP_BLENDING_MULTIPLY";break;case cu:t="ENVMAP_BLENDING_MIX";break;case hu:t="ENVMAP_BLENDING_ADD";break}return t}function w0(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function E0(s,t,e,n){const i=s.getContext(),a=e.defines;let r=e.vertexShader,o=e.fragmentShader;const l=b0(e),c=x0(e),h=M0(e),u=S0(e),d=w0(e),f=d0(e),g=f0(a),_=i.createProgram();let m,p,w=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(cs).join(`
`)),r=io(r),r=Ol(r,e),r=Bl(r,e),o=io(o),o=Ol(o,e),o=Bl(o,e),r=zl(r),o=zl(o),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
