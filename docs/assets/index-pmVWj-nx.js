...
`].filter(hs).join(`
`)),r=co(r),r=$l(r,e),r=jl(r,e),o=co(o),o=$l(o,e),o=jl(o,e),r=Gl(r),o=Gl(o),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+f);const w=b+m+r,y=b+f+o,U=zl(i,i.VERTEX_SHADER,w),E=zl(i,i.FRAGMENT_SHADER,y);i.attachShader(_,U),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(L){if(s.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(U).trim(),$=i.getShaderInfoLog(E).trim();let q=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,U,E);else{const Z=Vl(i,U,"vertex"),j=Vl(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
