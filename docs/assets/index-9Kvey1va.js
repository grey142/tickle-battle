...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Al(){return new jn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:To(),fragmentShader:`
		...
		`,blending:On,depthTest:!1,depthWrite:!1})}function Rl(){return new jn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:To(),fragmentShader:`
...
#define LOW_PRECISION`),t}function b0(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===kc?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===jh?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===gn&&(t="SHADOWMAP_TYPE_VSM"),t}function x0(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Bi:case Oi:t="ENVMAP_TYPE_CUBE";break;case ya:t="ENVMAP_TYPE_CUBE_UV";break}return t}function M0(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Oi:t="ENVMAP_MODE_REFRACTION";break}return t}function S0(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Nc:t="ENVMAP_BLENDING_MULTIPLY";break;case cu:t="ENVMAP_BLENDING_MIX";break;case hu:t="ENVMAP_BLENDING_ADD";break}return t}function w0(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function E0(s,t,e,n){const i=s.getContext(),a=e.defines;let r=e.vertexShader,o=e.fragmentShader;const l=b0(e),c=x0(e),h=M0(e),u=S0(e),d=w0(e),f=d0(e),g=f0(a),_=i.createProgram();let m,p,w=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(cs).join(`
`)),r=io(r),r=Ol(r,e),r=zl(r,e),o=io(o),o=Ol(o,e),o=zl(o,e),r=Hl(r),o=Hl(o),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+p);const S=w+m+r,x=w+p+o,N=Nl(i,i.VERTEX_SHADER,S),T=Nl(i,i.FRAGMENT_SHADER,x);i.attachShader(_,N),i.attachShader(_,T),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(L){if(s.debug.checkShaderErrors){const H=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(N).trim(),j=i.getShaderInfoLog(T).trim();let Y=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,N,T);else{const Q=Bl(i,N,"vertex"),V=Bl(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
  ...
  <div id="lookzone"></div>
  `}const Nh=document.querySelector("#app");if(!Nh)throw new Error("#app missing");new rU(Nh);
