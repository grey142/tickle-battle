...
- Walkable plaza ships with over-shoulder third-person mannequin on multi-frame idle sheets plus Home/Shop/Arena near-door soft glow/pulse + inner/outer sills + triple-biased-smoothstep approach + stronger frame lift + deeper jamb-tip unjam wall-slide + hardened Leave/Return (ephemeral wipe + ~0.75s confirm grace); remaining hub polish still TBD
- Painterly four-clip production anims and blendshapes still missing (tickle five-frame deepened A-pose cycle + intensity pick, run four-frame oil-grade adaptations past #48, laugh five-frame stamina-weighted cycle + blend deepen ship; full painterly anims TBD).
