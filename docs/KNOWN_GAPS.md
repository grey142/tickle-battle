...
- Walkable plaza ships with over-shoulder third-person mannequin on multi-frame idle sheets plus Home/Shop/Arena near-door soft glow/pulse + inner/outer sills + sign opacity ramp + jamb-tip unjam wall-slide + hardened Leave/Return (ephemeral wipe + confirm grace); remaining hub polish still TBD
